	...
	implements Searchable280<I>
{
	 ...
	 * @return The imbalance of the root of this tree.  
	 * If the return value is negative, the tree is right-heavy, otherwise it is left-heavy. 
	 */
	...
	protected void delete(I toBeDeleted, AVLTreeNode280<I> parent, AVLTree280<I> originalTree) {
		...
		if( toBeDeleted.compareTo(this.rootItem()) < 0 ) {
			...
			if( foundReplacement ) {
				...
				// If the node we are replacing is the root of the tree, 
